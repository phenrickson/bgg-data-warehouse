...
class BigQuerySetup:
        ...
        schemas = {
            ...
            "request_log": [
                ...
                bigquery.SchemaField(
                    "game_ids", "STRING"
                ),  # Store as string since it could be a single ID or list
            ...
            "raw_responses": [
                ...
                bigquery.SchemaField("last_refresh_timestamp", "TIMESTAMP"),
    ...
    def _get_schema(self, table_name: str) -> List[bigquery.SchemaField]:
        ...
        schemas = {
            ...
            "rankings": [
                ...
                bigquery.SchemaField(
                    "ranking_name", "STRING", mode="REQUIRED"
                ),  # Now part of composite key
    ...
    def create_table(self, table_config: Dict, dataset_ref: str, is_raw: bool = False) -> None:
        ...
        schema = (
            self._get_raw_schema(table_config["name"])
            if is_raw
            else self._get_schema(table_config["name"])
        )
